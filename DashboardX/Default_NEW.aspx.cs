...
public partial class Default : System.Web.UI.Page 
{
    ...
    {
        //GridTableView gtv = new GridTableView(MainGrid);
        //gtv.AllowNaturalSort = true;

        //Excel.FillGrid(MainGrid, Excel.GetDataSetFromFile(Server.MapPath("etc/sampledata.xls")));
    }
