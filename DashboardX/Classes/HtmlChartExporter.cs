...
public static class HtmlChartExporter
{
	...
	public static void ExportHtmlChart(HtmlChartExportSettings settings)
	{
        ...
        string sArgs = String.Format("--file \"{0}\" --export-{1} \"{2}\"" + ( (settings.Width != null && settings.Height!=null && settings.Width!=0 && settings.Height!=0) ? " --export-width {3} --export-height {4}" : "" ),
